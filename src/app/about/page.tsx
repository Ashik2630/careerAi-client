...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors">
      ...
      {/* Hero */}
      <section className="py-16 sm:py-24 bg-gradient-to-b from-blue-50/40 via-white to-white dark:from-slate-950 dark:via-slate-950 dark:to-slate-950 text-center transition-colors">
      ...
      {/* Stats Section */}
      <section className="py-12 bg-slate-50 dark:bg-slate-900/80 border-y border-gray-100 dark:border-slate-800 transition-colors">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {stats.map((stat, idx) => (
            <div key={idx} className="space-y-1">
              <div className="text-3xl sm:text-4xl font-serif font-bold text-[#3b28cc] dark:text-purple-400">{stat.value}</div>
              <div className="text-xs sm:text-sm font-medium text-gray-500 dark:text-slate-400">{stat.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-3 mb-16">
          <h2 className="text-3xl sm:text-4xl font-serif font-bold text-slate-900 dark:text-white">Driven by Core Principles</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 rounded-3xl border border-gray-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 space-y-3 shadow-2xs">
            <div className="w-10 h-10 rounded-xl bg-purple-50 dark:bg-purple-950/60 text-[#3b28cc] dark:text-purple-400 flex items-center justify-center font-bold">
              <Heart className="w-5 h-5" />
            </div>
            <h3 className="text-xl font-serif font-bold text-slate-900 dark:text-white">Empathetic Intelligence</h3>
          ...
          <div className="p-8 rounded-3xl border border-gray-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 space-y-3 shadow-2xs">
            ...
            <h3 className="text-xl font-serif font-bold text-slate-900 dark:text-white">Precision Growth</h3>
            <p className="text-xs sm:text-sm text-gray-500 dark:text-slate-400 leading-relaxed">
          ...
          <div className="p-8 rounded-3xl border border-gray-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 space-y-3 shadow-2xs">
            ...
            <h3 className="text-xl font-serif font-bold text-slate-900 dark:text-white">Privacy & Ownership</h3>
            <p className="text-xs sm:text-sm text-gray-500 dark:text-slate-400 leading-relaxed">
      ...
      {/* Leadership Team */}
      <section className="py-20 bg-slate-50/60 dark:bg-slate-900/60 border-t border-gray-100 dark:border-slate-800 transition-colors">
        <div className="max-w-6xl mx-auto px-4 space-y-12">
          <div className="text-center space-y-3">
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-slate-900 dark:text-white">Leadership Team</h2>
            <p className="text-gray-500 dark:text-slate-400 max-w-xl mx-auto text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {team.map((member, idx) => (
              <div key={idx} className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-gray-200/80 dark:border-slate-800 text-center space-y-3">
                ...
                <div>
                  ...
                  <p className="text-xs font-semibold text-[#3b28cc] dark:text-purple-400">{member.role}</p>
                </div>
                <p className="text-xs text-gray-500 dark:text-slate-400 leading-relaxed">{member.bio}</p>
              </div>
            ))}
          </div>
        </div>
